...
const APP_CARDS = [
  {
    ...
    description: "Distill safe drinking water for households, clinics, and whole communities.",
  },
  {
    title: "Water heating & sanitation",
    description: "Reliable hot water for homes, schools, healthcare, and hygiene systems.",
  },
  {
    title: "Coastal & marine systems",
    description: "Convert saltwater into drinking water for coastal and island communities.",
  },
  {
    title: "Off-grid resilience",
    description: "Continuous operation in disaster zones and water-stressed regions.",
  },
  {
    title: "Plastic-to-energy",
    description: "Turn plastic waste into thermal energy that powers water treatment.",
  },
  {
    title: "Community water access",
    description: "Centralized water points for villages and peri-urban neighborhoods.",
  },
  {
    title: "Schools & institutions",
    description: "Safe, steady water supply for kitchens, washrooms, and learning hubs.",
  },
  {
    title: "Emergency water relief",
    description: "Rapid-deploy distillation for floods, droughts, and relief operations.",
  },
];
  ...
  if (isMobile || reducedMotion) {
    return (
      <section
        ...
        aria-label="Water applications themes"
      >
        ...
        <div className="hc-app-themes__container">
          <div className="hc-app-themes__grid-static" role="list" aria-label="Water applications">
